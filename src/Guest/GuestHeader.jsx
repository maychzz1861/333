...
// Import NavLink เพื่อใช้งานคอมโพเนนต์ NavLink จาก react-router-dom
import { NavLink } from 'react-router-dom';

// Import ไฟล์วิดีโอพื้นหลัง เพื่อใช้เป็นพื้นหลังของหน้า GuestHeader
import videoBackground from '../photos/gg.mp4';

// สร้างคอมโพเนนต์ GuestHeader ซึ่งเป็นหัวเว็บไซต์สำหรับผู้ใช้ที่ยังไม่ได้ล็อกอิน
function GuestHeader() {
  return (
    // ส่วนของ Navbar บนสุดของเว็บไซต์
    <div className="navbar-container">
      <div className="navbar bg-gradient-to-r from-orange-200 via-red-300 to-red-200" style={{ position: 'fixed', top: 0, left: 0, right: 0, zIndex: 999 }}>
        ...
        <div className="indicator mr-1">
          ...
          <NavLink to="/login" className="flex items-center mx-6">
            {/* ไอคอนของสัญลักษณ์ของการล็อกอิน */}
      ...
      <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', position: 'absolute', top: 0, left: 0, width: '100%', height: '100%' }}>
        {/* ข้อความต้อนรับ */}
        <p className="text-6xl font-semibold mb-6 text-animation" style={{ backgroundImage: 'linear-gradient(to top, #FFC0CB, #FFFFFF)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', fontSize: '3rem', fontFamily: 'Arial, sans-serif', letterSpacing: '-0.02em' }}>ยินดีต้อนรับเข้าสู่!</p>
        {/* ชื่อเว็บไซต์ */}
        <p className="text-6xl font-semibold mb-6 text-animation" style={{ backgroundImage: 'linear-gradient(90deg, #dc2626, #059669)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', fontSize: '5rem', fontFamily: 'Playfair Display' }}>Vanta Pizza</p>
        {/* ข้อความอธิบาย */}
        <p className="text-white text-1xl font-semibold mb-6 text-animation" style={{ textShadow: '2px 2px #000000', fontSize: '1.2rem', fontFamily: 'Roboto Slab', letterSpacing: '-0.03em' }}>
...
// ส่งออกคอมโพเนนต์ GuestHeader เพื่อนำไปใช้งานในที่อื่นๆ
